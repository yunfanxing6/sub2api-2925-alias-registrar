...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--sleep", type=float, default=3600.0, help="Sleep seconds between accounts")
    ...
    parser.add_argument("--phone-risk-cooldown", type=float, default=3600.0, help="Cooldown seconds after repeated phone-risk failures")
